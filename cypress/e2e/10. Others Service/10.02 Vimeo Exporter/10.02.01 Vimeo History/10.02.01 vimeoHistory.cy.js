describe("Get vimeo history with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get vimeo history", () => {
    cy.request({
      method: "GET",
      url: "/settings/vimeo/history?page=1&limit=30&direction=asc&number=false",
      headers: {
