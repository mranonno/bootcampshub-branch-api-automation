describe("Get all shout out with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all shout out", () => {
    cy.request({
      method: "GET",
      url: "/communication/allposts/shout?page=1&limit=10&sort_by=newwst&program=&session=&query=",
      headers: {
