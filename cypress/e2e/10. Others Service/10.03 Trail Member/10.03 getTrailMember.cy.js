describe("Get all trail members with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all trail members", () => {
    cy.request({
      method: "GET",
      url: "/user/students/trial?page=1&limit=30&program=&session=&query=",
      headers: {
