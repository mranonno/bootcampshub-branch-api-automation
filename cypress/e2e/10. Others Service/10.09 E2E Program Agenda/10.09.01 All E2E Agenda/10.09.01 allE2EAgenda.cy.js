describe("Get all e2e agenda with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all e2e agenda", () => {
    cy.request({
      method: "GET",
      url: "/document/getall/e2e?page=1&limit=30&program=&session=&query=",
      headers: {
