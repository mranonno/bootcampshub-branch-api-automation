describe("Get all url shortener with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all url shortener", () => {
    cy.request({
      method: "GET",
      url: "/short-url/getall?page=1&limit=20&sort=newest",
      headers: {
