describe("Get users issues details with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get users issues details", () => {
    cy.request({
      method: "GET",
      url: "/communication/allposts/issues/662881e86151d4001ac8aa2f?page=1&limit=12",
      headers: {
