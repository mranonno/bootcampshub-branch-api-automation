describe("Get all portal issues with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all portal issues", () => {
    cy.request({
      method: "GET",
      url: "/communication/userlist/issues?page=1&limit=10",
      headers: {
