describe("Get send bulk history with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get send bulk history", () => {
    cy.request({
      method: "GET",
      url: "/chat/sendbulk/history/getall?page=1&limit=10",
      headers: {
