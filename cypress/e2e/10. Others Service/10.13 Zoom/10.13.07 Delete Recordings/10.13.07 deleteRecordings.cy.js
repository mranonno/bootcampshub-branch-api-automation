describe.skip("Delete recordings with status code 200", () => {
  let accessToken;
  let branchId, zoomId;
  before(() => {
  ...
  it("Checking if should be able to delete recordings", () => {
    cy.request({
      method: "DELETE",
      url: "/organization/integration/zoom/recording-delete/aZTlLZaqS9Wmtok1LgGqzA==",
      headers: {
