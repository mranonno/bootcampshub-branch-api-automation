describe("Get meetings details with status code 200", () => {
  let accessToken;
  ...
  it("Checking if should be able to get meetings details", () => {
    cy.request({
      method: "GET",
      url: `/organization/integration/zoom/meeting-details?id=${meetingId}`,
      headers: {
