describe("Get mock interview answer with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get mock interview answer", () => {
    cy.request({
      method: "GET",
      url: "/interview/allsubmission?page=1&limit=10&sort=newest&interview=&query=&program=&session=",
      headers: {
