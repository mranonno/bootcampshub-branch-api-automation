describe("Get submission users with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get submission users", () => {
    cy.request({
      method: "GET",
      url: "/interview/submissionusers?sort=newest&page=1&limit=10",
      headers: {
