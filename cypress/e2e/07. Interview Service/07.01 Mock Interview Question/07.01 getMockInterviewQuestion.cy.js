describe("Get mock interview questions with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get mock interview questions", () => {
    cy.request({
      method: "GET",
      url: "/interview/getall?page=1&limit=10",
      headers: {
