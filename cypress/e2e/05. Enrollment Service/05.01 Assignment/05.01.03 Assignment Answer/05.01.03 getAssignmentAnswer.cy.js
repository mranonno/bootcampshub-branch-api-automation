describe("Get assignment answer with status code 200", () => {
  let accessToken;
  let branchId;
  let assignmentId;
  before(() => {
  ...
  it("Checking if should be able to get assignment answer", () => {
    cy.request({
      method: "GET",
      url: `/assignment/answers/${assignmentId}?page=${1}&limit=${30}`,
      headers: {
