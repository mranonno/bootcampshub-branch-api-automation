describe("Get inactive members with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get inactive members", () => {
    cy.request({
      method: "GET",
      url: "/user/students/inactive?page=1&limit=20&program=&session=",
      headers: {
