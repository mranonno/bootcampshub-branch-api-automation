describe("Get pending member with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get pending member", () => {
    cy.request({
      method: "GET",
      url: "/user/students/pending?page=1&limit=10&program=&session=",
      headers: {
