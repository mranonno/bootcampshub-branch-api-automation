describe("Get single student with status code 200", () => {
  let accessToken;
  let branchId;
  let userId = "6672cda4d76d59001a71b0f1";
  before(() => {
  ...
  it("Checking if should be able to get single student", () => {
    cy.request({
      method: "GET",
      url: `/user/students/single/${userId}`,
      headers: {
