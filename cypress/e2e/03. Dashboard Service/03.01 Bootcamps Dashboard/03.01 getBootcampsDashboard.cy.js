describe("Get bootcamps dashboard data with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get bootcamps dashboard data", () => {
    cy.request({
      method: "POST",
      ...
      body: { bootcamp: { _id: "64fcb957b0cf6e9ae43d126d" } },
