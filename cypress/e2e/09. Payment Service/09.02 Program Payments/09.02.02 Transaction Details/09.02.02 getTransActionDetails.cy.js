describe("Get transaction with status code 200", () => {
  let accessToken;
  let branchId;
  let transactionId = "6512b3ca88331100200778ce";
  before(() => {
  ...
  it("Checking if should be able to get transaction", () => {
    cy.request({
      method: "GET",
      url: `/transaction/getdetails/${transactionId}`,
      headers: {
