describe("Get invoice user data with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get invoice user data", () => {
    cy.request({
      method: "GET",
      url: "/invoice/getuserdata",
      headers: {
        Authorization: `Bearer ${accessToken}`,
        Branch: branchId,
      },
      body: { enrollment: "6523d8d71eab265c60cf30ce", invoice: "create" },
