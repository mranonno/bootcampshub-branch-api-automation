describe("Find content by program with status code 200", () => {
  let accessToken;
  let branchId;
  let programId;
  before(() => {
  ...
  it("Checking if should be able to find content by program", () => {
    cy.request({
      method: "GET",
      url: `/content/findcontent?program=${programId}`,
      headers: {
