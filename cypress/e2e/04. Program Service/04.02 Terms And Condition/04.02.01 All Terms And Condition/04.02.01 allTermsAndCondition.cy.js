describe("Get all terms and conditions with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all terms and conditions", () => {
    cy.request({
      method: "GET",
      url: "/terms-conditions/getall?page=1&limit=10&sort=newest",
      headers: {
