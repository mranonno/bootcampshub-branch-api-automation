describe("Create terms and condition with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to create terms and condition", () => {
    cy.request({
      method: "POST",
      ...
      if (response.status === 200) {
        ...
        cy.writeFile("cypress/fixtures/termsId.json", {
          termsId: body.term._id,
        });
