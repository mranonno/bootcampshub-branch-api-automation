describe("Get course chapter v2 with status code 200", () => {
  let accessToken;
  let branchId;
  let programId;
  let categoryId;
  before(() => {
    ...
    cy.readFile("cypress/fixtures/categoryId.json").then((category) => {
      categoryId = category.categoryId;
    });
  });
  it("Checking if should be able to get course chapter v2", () => {
    cy.request({
      method: "GET",
      url: `/course/chapterv2/get/${programId}/${categoryId}`,
      headers: {
