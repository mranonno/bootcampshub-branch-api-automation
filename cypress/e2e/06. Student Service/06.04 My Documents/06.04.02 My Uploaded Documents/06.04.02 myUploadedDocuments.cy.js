describe("Get my uploaded document with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get my uploaded document", () => {
    cy.request({
      method: "GET",
      url: "/document/userdocument/users?page=1&limit=30",
      headers: {
