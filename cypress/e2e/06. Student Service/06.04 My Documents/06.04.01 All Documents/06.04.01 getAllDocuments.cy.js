describe("Get all documents with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all documents", () => {
    cy.request({
      method: "GET",
      url: "/document/getall/document?page=1&limit=10&sort=newest",
      headers: {
