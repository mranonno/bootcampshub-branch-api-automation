describe("Delete certificate with status code 200", () => {
  let accessToken;
  let branchId;
  let certificateId;
  before(() => {
    ...
    cy.readFile("cypress/fixtures/certificateId.json").then((certificate) => {
      certificateId = certificate.certificateId;
    });
  });
  it("Checking if should be able to delete certificate", () => {
    cy.request({
      method: "DELETE",
      url: `/certificate/delete/${certificateId}`,
      headers: {
