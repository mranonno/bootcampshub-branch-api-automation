describe("Get single question with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get single question", () => {
    cy.request({
      method: "GET",
      url: "/interviewqa/question/getall/66dcbd03a828723fac204574",
      headers: {
