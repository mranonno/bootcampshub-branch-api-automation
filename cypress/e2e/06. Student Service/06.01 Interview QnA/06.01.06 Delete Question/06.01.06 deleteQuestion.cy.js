describe("Delete interview question with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to delete interview question", () => {
    cy.request({
      method: "DELETE",
      url: "/interviewqa/delete/6644492e68f0cb00206d9ae0",
      headers: {
