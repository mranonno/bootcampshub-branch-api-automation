describe("Get all interview question with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all interview question", () => {
    cy.request({
      method: "GET",
      url: "/interviewqa/getall?page=1&limit=10&program=&chapter=&sort=newest&query=",
      headers: {
