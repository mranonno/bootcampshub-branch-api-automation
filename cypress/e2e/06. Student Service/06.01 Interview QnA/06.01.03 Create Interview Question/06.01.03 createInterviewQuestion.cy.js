describe.skip("Create interview question with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to create interview question", () => {
    cy.request({
      method: "POST",
      url: "/interviewqa/add",
      headers: {
      ...
      body: {
        name: "How can we API automation by cypress?",
        programs: ["6501f8b21c01cf0019303d0b"],
        sessions: ["664a63c81a88ea0019515a20"],
        isActive: "active",
      },
