describe("Get approved students with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get approved students", () => {
    cy.request({
      method: "GET",
      url: "/user/students/approved?page=1&limit=30&sort=",
      headers: {
