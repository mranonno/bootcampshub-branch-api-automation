describe("Get user show and tell with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get user show and tell", () => {
    cy.request({
      method: "GET",
      url: "/show-tell/byuser/6523d8d71eab265c60cf30ce",
      headers: {
