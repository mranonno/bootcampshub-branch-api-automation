describe("Get all show n tell with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all show n tell", () => {
    cy.request({
      method: "GET",
      url: "/show-tell/getusers?page=1&limit=10&sort=newest",
      headers: {
