describe("Get all diagram with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all diagram", () => {
    cy.request({
      method: "GET",
      url: "/diagram/getall?page=1&limit=10&program=&session=&query=&category=",
      headers: {
