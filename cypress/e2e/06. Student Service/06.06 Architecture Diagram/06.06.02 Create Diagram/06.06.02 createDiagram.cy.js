describe("Create diagram with status code 201", () => {
  ...
  it("Checking if should be able to create diagram", () => {
    cy.request({
      method: "POST",
      url: "/diagram/create",
      headers: {
      ...
      body: {
        title: "Create Diagram for api test",
      ...
      if (response.status === 201) {
        ...
        cy.writeFile("cypress/fixtures/diagramId.json", {
          diagramId: body.diagram._id,
        });
