describe("Get all slides with status code 200", () => {
  let accessToken;
  let branchId;
  before(() => {
  ...
  it("Checking if should be able to get all slides", () => {
    cy.request({
      method: "GET",
      url: "/slide/getall?page=1&limit=8&program=&session=&query=&sort=newest",
      headers: {
